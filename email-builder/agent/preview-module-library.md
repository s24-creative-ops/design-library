...
### `teaser-1col-no-image`

- Snippet: `emb_teaser_1col_no_image`
- Preview-Quelle: `preview-modules.html`, Block `data-module="teaser-1col-no-image"`
- Sichtbare Felder:
  - Eyebrow
  - Badge
  - Headline
  ...
  - Button-Label
  - Button-URL
- Bildformat in der Preview: Kein Bild
- Fuellhinweis: Bildlosen Teaser mit optionalem Eyebrow oder Badge, Richtext und CTA beibehalten
